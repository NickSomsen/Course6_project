...
dplyr::filter(fit$table, fit$table$logFC > 4.728096 | fit$table$logFC < -3.152701) # met de filter functie van dplyr kun je wel op meerdere condities te gelijk filteren, met de & of | operators net als in Java. Omdat ik 2 packages geïnstalleerd heb die beide een "filter" functie hebben, moet ik aangegeven van welke package ik de filter functie wil gebruiken
