...
Zodat de data makkelijker te lezen is, worden de twee data frames weggeschreven naar een bestand, die vervolgesn bijvoorbeeld in excel ingeladen kan worden.
```{r write results}
