...
## KEGG Mapper
De normale glycolyse pathway:
![Volledige pathview Glycolysis](lpl00010.png)
...
```
De genen bij WCFS1 (let op doordat: wanneer die van NC8 ook wordt uitgevoerd, dan wordt de afbeelding overschreven, waardoor deze ook de NC8 afbeelding weergeeft):

![Glycolysis marked with WCFS1 genes](lpl00010.pathview.png)
...
```
De genen bij NC8 (NC8 staat nu uit commented, dus hier wordt ook die van WCFS1 weergegeven):

![Glycolysis marked with NC8 genes](lpl00010.pathview.png)
<br>
