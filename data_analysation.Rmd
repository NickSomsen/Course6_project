...
Voor een DGEList moet de counts data (vanuit de dataset) en de groepen worden opgegeven; een factor die de condities van elke sample aangeven (dus een glucose of ribose voedingsbodem). Het aanmaken van die groups gaat als volgt:
