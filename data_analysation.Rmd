...
library(xlsx)
library(openxlsx)
results <- write.xlsx(combined_wcfs1, paste(here(), "results.xlsx", sep = "/"), sheetName = "wcfs1_results", row.names = TRUE)

addWorksheet(results, sheetName = "nc8_results")

writeData(results, sheet = "nc8_results", combined_nc8, rowNames = TRUE)

saveWorkbook(results, "results.xlsx", overwrite = TRUE)
```
...
![Glycolysis marked with WCFS1 genes](lpl00010.wcfs1.png)
...
![Glycolysis marked with NC8 genes](lpl00010.nc8.png)
