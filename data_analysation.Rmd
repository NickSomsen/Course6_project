...
combined_wcfs1 = combined_wcfs1[, 0:15] # de laatste paar kolommen worden eruit gehaald, want die horen er niet te staan
...
combined_nc8 = combined_nc8[, 0:15] # verwijder laatste kolommen
```
...
selected_wcfs1 = wcfs1[c("lp_3658", "lp_0371"), ]
genes <- row.names(selected_wcfs1)
logFC <- selected_wcfs1$logFC
names(logFC) <- genes
