...
De genen met het grootste verschil in fold changes (en dus expressie) tussen een glucose en ribose voedingsbodem van de WCFS1 stam kunnen dan worden weergegeven met `topTags`:
...
## Cluster genes
We moeten nog genen clusteren met hclust() of kmeans()
